## PASSANDO VALOR DE OUTRA ELA PARA ESSA
## VAI APARECER NOME DO USUÁRIO NA BAR
...
class Ui_Menu(object):
    ...
    def retranslateUi(self, Menu):
        ...
        Menu.setWindowTitle(_translate("Menu", f"Menu do Sistema - Usuário: {self.usuario}"))
